...
image = 'quay.io/' + os.environ['repo'] + '/gitwebhook-operator'

# Go Build
local_resource(
  'gitwebhook-operator-compile',
  compile_cmd,
...
k8s_resource('gitwebhook-operator-controller-manager',
  resource_deps=['gitwebhook-operator-compile', 'gitwebhook-operator-manifests'])